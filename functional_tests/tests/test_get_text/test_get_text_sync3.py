...
def test_get_text_from_settings_page(driver_sync3):
...
# negative tests
@allure.testcase(TASK_LINK.format("VHAT-1317"), "VHAT-1317")
def test_get_text_from_empty_area(driver_sync3):
    driver_sync3.settings_page.open_settings_page()
...
def test_error_invalid_rectangle_cordinations(driver_sync3, test_data):
