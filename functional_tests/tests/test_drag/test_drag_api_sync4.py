...
def test_drag_api_horizontally(driver_sync4):
    ...
    assert helpers.get_exist_result(constants.SETTINGS_PAGE_VEHICLE_BUTTON)
    ...
    assert helpers.get_exist_result(constants.CLOCK_SETTINGS_TEXT)
...
def test_drag_api_vertically(driver_sync4):
    ...
    assert helpers.get_exist_result(constants.MASTER_RESET_TEXT)
