...
def navigation_settings_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.SETTINGS_NAVIGATION_GUIDANCE_PROMPTS_VOICE_ACTIVE, counter)
    helpers.get_result_recognition(Icons.SETTINGS_NAVIGATION_GUIDANCE_PROMPTS_VOICE_INACTIVE, counter)
    helpers.get_result_recognition(Icons.SETTINGS_NAVIGATION_GUIDANCE_PROMPTS_PLUS, counter)
...
def clock_settings_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.SETTINGS_CLOCK_12H_FORMAT, counter)
...
def sound_settings_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.RESET_ALL_BUTTON, counter)
    ...
    helpers.get_result_recognition(Icons.ARROW_UP_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.ARROW_DOWN_BUTTON_ACTIVE, counter)
    helpers.get_result_recognition(Icons.SETTINGS_SOUND_BALANCE_FADE_BUTTON, counter)
    driver.settings_audio_page.tap_on_down_scroll_button()
    helpers.get_result_recognition(Icons.ARROW_UP_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.ARROW_DOWN_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.INFO_BUTTON, counter)
    helpers.get_result_recognition(Icons.MEDIUM_BUTTON, counter)
...
def main_settings_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.SETTINGS_BLUETOOTH_BUTTON, counter)
    ...
    helpers.get_result_recognition(Icons.SETTINGS_SYNC_CONNECT_BUTTON, counter)
    helpers.get_result_recognition(Icons.MAIN_SETTINGS_BUTTON_ACTIVE, counter)
...
def mobile_apps_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.SETTINGS_BLUETOOTH_BUTTON, counter)
    helpers.get_result_recognition(Icons.APPS_FIND_MOBILE_APPS_BUTTON, counter)
    helpers.get_result_recognition(Icons.APPS_SIRIUSXM_BUTTON, counter)
    helpers.get_result_recognition(Icons.MAIN_APPS_BUTTON_ACTIVE, counter)
...
def phone_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.PHONE_CONNECT_TO_BUTTON, counter)
...
def climate_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.CLIMATE_ON_OFF_BUTTON_ACTIVE, counter)
    helpers.get_result_recognition(Text.DUAL_TEXT, counter)
    helpers.get_result_recognition(Icons.CLIMATE_ARROW_UP_BUTTON, counter)
    helpers.get_result_recognition(Icons.CLIMATE_ARROW_DOWN_BUTTON, counter)
    helpers.get_result_recognition(Icons.DEFROST, counter)
    helpers.get_result_recognition(Icons.CLIMATE_TOP_AIRFLOW_BUTTON_ACTIVE, counter)
    helpers.get_result_recognition(Icons.CLIMATE_DOWN_AIRFLOW_BUTTON_ACTIVE, counter)
    helpers.get_result_recognition(Icons.CLIMATE_A_C_BUTTON_ACTIVE, counter)
    ...
    helpers.get_result_recognition(Icons.CLIMATE_DEFROST_MAX_FRONT_HEATING_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.CLIMATE_DEFROST_FRONT_HEATING_BUTTON_ACTIVE, counter)
    helpers.get_result_recognition(Icons.CLIMATE_DEFROST_REAR_HEATING_BUTTON_ACTIVE, counter)
    driver.climate_page.close_information_dialog()
    helpers.get_result_recognition(Icons.MAIN_CLIMATE_BUTTON_ACTIVE, counter)
...
def audio_page(counter, driver):
    ...
    helpers.get_result_recognition(Icons.AUDIO_PRESETS_BUTTON, counter)
    helpers.get_result_recognition(Icons.MAIN_AUDIO_BUTTON_ACTIVE, counter)


def home_page(counter):
    helpers.get_result_recognition(Icons.HOME_PAGE_ICON, counter)
    helpers.get_result_recognition(Icons.MAIN_AUDIO_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.MAIN_CLIMATE_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.MAIN_PHONE_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.MAIN_NAVIGATION_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.MAIN_APPS_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.MAIN_SETTINGS_BUTTON_INACTIVE, counter)
    helpers.get_result_recognition(Icons.HOME_EXCLAMATION_ICON, counter)
