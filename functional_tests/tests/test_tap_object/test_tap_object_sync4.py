...
def test_tap_object_by_object_data(driver_sync4):
...
def test_tap_object_by_screen_point_object_data(driver_sync4):
...
def test_tap_object_by_screen_rectangle_object_data(driver_sync4):
...
def test_none_value_for_tap_object(driver_sync4):
    test_object = hmi.wait_for_object(Icons.MAIN_AUDIO_BUTTON_INACTIVE)
