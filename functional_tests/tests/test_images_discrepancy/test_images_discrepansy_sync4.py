...
from functional_tests.pages.sync4.pages import AudioPage, ClimatePage
...
pytestmark = [pytest.mark.get_images_discrepancy_api, pytest.mark.regression_sync4]
...
def test_comparison_different_part_screenshots(create_temporary_folder):
    path_1, path_2 = get_path_screenshots()
    discrepancy_percentage = get_images_discrepancy(path_1, path_2, set_point(10, 10), set_point(500, 500))
    assert 0 < discrepancy_percentage <= 100
...
def test_comparison_same_part_screenshots(create_temporary_folder):
    path_1, path_2 = get_path_screenshots()
    # add equal images to compare
    discrepancy_percentage = get_images_discrepancy(path_1, path_1, set_point(10, 10), set_point(500, 500))
    assert discrepancy_percentage == 0
