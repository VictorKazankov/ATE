...
public ref class API {
 public:
  ...
  /** <summary>
      ...
      <exception cref="System::Exception">Thrown if internal error has occurred.</exception>
   **/
  static ATE::Object^ WaitForObject(System::String^ objectOrName, ScreenPoint topLeft, ScreenPoint bottomRight);
  ...
  /** <summary>
      ...
      <exception cref="System::Exception">Thrown if internal error has occurred.</exception>
   **/
  static ATE::Object^ WaitForObject(ATE::Object^ objectOrName, int timeoutMSec, ScreenPoint topLeft,
  ...
  /** <summary>
      ...
      <exception cref="System::Exception">Thrown if internal error has occurred.</exception>
   **/
  static ATE::Object^ WaitForObject(Wildcard^ wildcard, int timeoutMSec, ScreenPoint topLeft,
                                    ScreenPoint bottomRight);
